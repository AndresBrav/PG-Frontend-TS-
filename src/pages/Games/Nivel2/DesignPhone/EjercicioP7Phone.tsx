...
const EjercicioP7Phone: React.FC = () => {
        ...
        if (todoCorrecto) {
            ...
            <div style="padding:4px;">
                ...
                ">
                    ...
                    Si está fuera de rango, el programa volverá a pedirlo.<br/>
                    Luego se mostrará la tabla de multiplicar.
                </div>
            </div>
            `,
            });
...
export default EjercicioP7Phone;
