...
const EjercicioP8Phone: React.FC = () => {
        ...
        if (todoCorrecto) {
            ...
            <div style="padding:4px;">
                ...
                ">
                    ...
                    El programa calculará la suma de los números pares<br/>
                    y la suma de los números impares desde 1 hasta N.
                </div>
            </div>
            `,
            });
...
export default EjercicioP8Phone;
