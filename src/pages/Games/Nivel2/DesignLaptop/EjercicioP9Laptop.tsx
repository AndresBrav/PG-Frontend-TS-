...
import { verificarResultadoPseudocodigo9 } from '../VerificarResultadoPseudo';
...
const EjercicioP9Laptop: React.FC = () => {
            ...
            const primerSwal = await Swal.fire({
                ...
                <div style="padding:8px;">
                    ...
                    <div style="
                        ...
                        line-height:1.5;
                    ">
                        Se pedirán 5 números enteros uno por uno.<br/>
                        Los números se guardarán en un arreglo de 5 posiciones.<br/>
                        Al final se mostrarán todos los números ingresados.
                    </div>
                </div>
                `,
            });
    ...
    const IncrementarPuntuacionEjercicio = async () => {
        if (counterRate == 1) {
            ...
            await incrementarPuntuacionApi(claveAcceso, ejerciciosId[13]);
        }
    ...
    const printOrder = () => {
        ...
        const resultados: boolean[] = verificarResultadoPseudocodigo9(ids);
    ...
    return (
        <div>
            ...
            <div className="contenedor-diagramaflujo-ejercicio1-explicacion">
                <h1>
                    Diseñar un pseudocódigo que declare un arreglo de 5
                    posiciones, permita al usuario ingresar 5 números y luego
                    muestre todos los números ingresados.
                </h1>
            </div>
...
export default EjercicioP9Laptop;
