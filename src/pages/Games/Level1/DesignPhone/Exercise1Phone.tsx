...
//           <h1 style="font-size:16px; margin:8px 0; color:green;">1) El inicio está correcto</h1>
//           <h1 style="font-size:16px; margin:8px 0; color:green;">2) El paso dos está correcto</h1>
//           <h1 style="font-size:16px; margin:8px 0; color:red;">3) El paso cuatro está mal</h1>
//           <h1 style="font-size:16px; margin:8px 0; color:red;">4) El paso cinco está mal</h1>
//         </div>
//     `,
//             icon: "success",
...
//             customClass: {
//                 popup: "swal-popup-custom", // aquí solo el popup
