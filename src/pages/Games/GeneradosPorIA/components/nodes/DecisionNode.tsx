...
function DecisionNode({ data, selected, id, selectedNodeId, onDeleteNode }: NodeProps & CustomNodeProps) {
  const isSelected = selected || selectedNodeId === id;

  return (
    <div className={`node-wrapper decision-wrapper ${isSelected ? 'selected' : ''}`}>
